...
import { $gl, $inverseMatrix, $context, $poolFloat32Array6 } from "../../WebGLUtil";
/**
...
export const execute = (vertex_array_object, offset, index_count, grid_data) => {
    ...
    const focal = $gradientData.shift();
    ...
    const shaderManager = variantsGradientShapeShaderUseCase(true, Boolean(focal), spread, useGrid);
    shaderManagerSetGradientFillUniformService(shaderManager, 1, prevMatrix, inverseMatrix, focal, grid_data);
    $context.restore();
