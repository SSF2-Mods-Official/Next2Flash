...
import { $rootNodes, $setActiveAtlasIndex, $getAtlasAttachmentObjects } from "../../AtlasManager";
/**
...
export const execute = () => {
    ...
    for (let idx = 0; idx < atlasAttachmentObjects.length; idx++) {
        frameBufferManagerReleaseAttachmentObjectUseCase(atlasAttachmentObjects[idx]);
    }
