 ...
 * @protected
 */
export const execute = (texture_object, matrix, distance = 4, angle = 45, color = 0, alpha = 1, blur_x = 4, blur_y = 4, strength = 1, quality = 1, inner = false, knockout = false, hide_object = false) => {
    ...
    const blurTextureObject = filterApplyBlurFilterUseCase(texture_object, matrix, blur_x, blur_y, quality, false);
