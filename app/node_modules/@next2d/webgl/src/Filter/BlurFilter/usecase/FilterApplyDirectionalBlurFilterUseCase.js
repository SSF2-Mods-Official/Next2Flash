 ...
 * @protected
 */
export const execute = (texture_object, is_horizontal, blur) => {
    ...
    shaderManagerSetBlurFilterUniformService(shaderManager, texture_object.width, texture_object.height, is_horizontal, fraction, samples);
