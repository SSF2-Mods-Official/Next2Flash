 ...
 * @protected
 */
export const execute = (texture_object, matrix, color = 0, alpha = 1, blur_x = 4, blur_y = 4, strength = 1, quality = 1, inner = false, knockout = false) => {
