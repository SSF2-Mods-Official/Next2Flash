...
import { $gl, $context, $getFloat32Array4 } from "../../WebGLUtil";
/**
...
export const execute = (x_min, y_min, x_max, y_max) => {
    ...
    // レベルと描画範囲をセット
    $clipBounds.set(currentAttachmentObject.clipLevel, $getFloat32Array4(x_min, y_min, x_max, y_max));
    const width = Math.ceil(Math.abs(x_max - x_min));
    const height = Math.ceil(Math.abs(y_max - y_min));
    $gl.enable($gl.SCISSOR_TEST);
    $gl.scissor(x_min, currentAttachmentObject.height - y_min - height, width, height);
};
