 ...
 * @private
 */
const STATEMENT_FOCAL_POINT_ON = (index) => {
    return `
 ...
 * @private
 */
const STATEMENT_FOCAL_POINT_OFF = () => {
 ...
 * @private
 */
const STATEMENT_GRADIENT_TYPE_RADIAL = (index, has_focal_point) => {
 ...
 * @private
 */
const STATEMENT_GRADIENT_TYPE_LINEAR = (index) => {
    return `
 ...
 * @private
 */
export const GRADIENT_TEMPLATE = (highp_length, fragment_index, is_radial, has_focal_point, spread_method) => {
