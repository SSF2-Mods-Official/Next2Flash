 ...
 * @private
 */
const STATEMENT_BASE_TEXTURE_TRANSFORM = (index) => {
    return `
 ...
 * @private
 */
const STATEMENT_BLUR_TEXTURE_TRANSFORM = (index) => {
    return `
 ...
 * @private
 */
const STATEMENT_GLOW_STRENGTH = (offset) => {
 ...
 * @static
 */
const STATEMENT_GLOW_SOLID_COLOR = (index) => {
    return `
 ...
 * @static
 */
const STATEMENT_GLOW_GRADIENT_COLOR = (transforms_base) => {
    return `
 ...
 * @private
 */
const STATEMENT_GLOW = (is_inner, transforms_base, applies_strength, is_gradient, color_index, strength_offset) => {
 ...
 * @static
 */
const STATEMENT_BLUR_TEXTURE_2 = () => {
    return `
 ...
 * @static
 */
const STATEMENT_BLUR_TEXTURE_TRANSFORM_2 = () => {
    return `
 ...
 * @static
 */
const STATEMENT_BEVEL_STRENGTH = (offset) => {
    const index = Math.floor(offset / 4);
    const component = offset % 4;
    return `
    float strength = u_mediump[${index}][${component}];
 ...
 * @static
 */
const STATEMENT_BEVEL_SOLID_COLOR = (index) => {
    return `
 ...
 * @static
 */
const STATEMENT_BEVEL_GRADIENT_COLOR = (transforms_base) => {
    return `
 ...
 * @static
 */
export const BITMAP_FILTER_TEMPLATE = (textures_length, mediump_length, transforms_base, transforms_blur, is_glow, type, knockout, applies_strength, is_gradient) => {
    let index = 0;
 ...
 * @static
 */
const STATEMENT_BEVEL = (transforms_base, transforms_blur, applies_strength, is_gradient, color_index, strength_offset) => {
