 ...
 * @protected
 */
export const execute = (transforms_base, transforms_blur, is_glow, type, knockout, applies_strength, is_gradient) => {
    ...
    const shaderManager = new ShaderManager(TEXTURE_TEMPLATE(), BITMAP_FILTER_TEMPLATE(texturesLength, mediumpLength, transforms_base, transforms_blur, is_glow, type, knockout, applies_strength, is_gradient));
