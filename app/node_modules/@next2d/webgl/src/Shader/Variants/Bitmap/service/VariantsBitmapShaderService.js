...
import { BITMAP_PATTERN, BITMAP_CLIPPED } from "../../../Fragment/FragmentShaderSource";
/**
 ...
 * @protected
 */
export const execute = (repeat, use_grid) => {
    ...
    const fragmentShaderSource = repeat
        ? BITMAP_PATTERN()
        : BITMAP_CLIPPED();
    const shaderManager = new ShaderManager(FILL_TEMPLATE(use_grid ? 14 : 5, true, false, use_grid), fragmentShaderSource);
