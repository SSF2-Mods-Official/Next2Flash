 ...
 * @private
 */
let $fillBuffer = new Float32Array(128);
/**
 * @type {number}
 * @private
 */
let $fillBufferOffset = 0;
/**
 ...
 * @protected
 */
export const $getFillBufferOffset = () => {
 ...
 * @protected
 */
export const $addFillBuffer = (buffer) => {
 ...
 * @protected
 */
export const $fillBufferIndexes = [];
/**
 ...
 * @protected
 */
export const $clearFillBufferSetting = () => {
    $fillTypes.length = 0;
    // fill
    $fillBufferOffset = 0;
