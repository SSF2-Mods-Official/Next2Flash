...
import { $setInstancedVertexArrayObject, $setAttributeWebGLBuffer } from "../../VertexArrayObject";
/**
...
export const execute = (gl) => {
    ...
    $setInstancedVertexArrayObject(vertexArrayObjectCreateInstancedVertexArrayObjectUseCase());
};
