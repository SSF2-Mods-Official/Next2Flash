...
export const execute = (texture_object, matrix, distance = 4, angle = 45, colors, alphas, ratios, blur_x = 4, blur_y = 4, strength = 1, quality = 1, type = 0, knockout = false) => {
    ...
    const textureObject = filterApplyBitmapFilterUseCase(texture_object, blurTextureObject, width, height, baseWidth, baseHeight, baseTextureX, baseTextureY, blurWidth, blurHeight, blurTextureX, blurTextureY, true, typeName, knockout, strength, ratios, colors, alphas, 0, 0, 0, 0, 0, 0, 0, 0);
