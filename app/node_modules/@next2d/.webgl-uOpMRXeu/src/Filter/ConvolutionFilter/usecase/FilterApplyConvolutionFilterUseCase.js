...
import { $intToR, $intToG, $intToB } from "../../../Filter";
/**
 ...
 * @protected
 */
export const execute = (texture_object, matrix_x = 0, matrix_y = 0, matrix, divisor = 1, bias = 0, preserve_alpha = true, clamp = true, color = 0, alpha = 0) => {
    ...
    blendResetService();
    const shaderManager = variantsConvolutionFilterShaderService(matrix_x, matrix_y, preserve_alpha, clamp);
    shaderManagerSetConvolutionFilterUniformService(shaderManager, width, height, matrix, divisor, bias, clamp, $intToR(color, alpha, false), $intToG(color, alpha, false), $intToB(color, alpha, false), alpha);
