...
import { $readFrameBuffer, $getPixelFrameBuffer } from "../../FrameBufferManager";
import { $context, $gl, $upperPowerOfTwo } from "../../WebGLUtil";
/**
 * @type {number}
 * @private
 */
 ...
 * @protected
 */
export const execute = async (width, height) => {
    // fixed logic
    ...
    $gl.readPixels(0, $mainAttachmentObject.height - height, width, height, $gl.RGBA, $gl.UNSIGNED_BYTE, 0);
