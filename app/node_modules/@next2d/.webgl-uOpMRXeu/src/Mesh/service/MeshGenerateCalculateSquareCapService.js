 ...
 * @protected
 */
export const execute = (vertices, r, rectangles) => {
    for (let idx = 0; idx < 2; ++idx) {
        ...
        if (idx === 0) {
            ...
            sx = vertices[vertices.length - 3];
            sy = vertices[vertices.length - 2];
            ex = vertices[vertices.length - 6];
            ey = vertices[vertices.length - 5];
        }
