 ...
 * @protected
 */
export const execute = (start_point, control_point, end_point, thickness) => {
    const segments = meshSplitBezierMultipleTimesUseCase(start_point, control_point, end_point, 5);
    // "左右" にオフセットした2次ベジエを作る
