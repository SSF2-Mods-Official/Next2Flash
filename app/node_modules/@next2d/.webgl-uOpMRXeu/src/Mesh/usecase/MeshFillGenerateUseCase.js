...
import { $context, $getViewportWidth, $getViewportHeight } from "../../WebGLUtil";
/**
 ...
 * @protected
 */
export const execute = (vertices, style = "fill") => {
    ...
    let currentIndex = 0;
    for (let idx = 0; idx < vertices.length; ++idx) {
        currentIndex = meshFillGenerateService(vertices[idx], buffer, currentIndex, a, b, c, d, tx, ty, red, green, blue, alpha);
    }
    return {
        "buffer": buffer,
