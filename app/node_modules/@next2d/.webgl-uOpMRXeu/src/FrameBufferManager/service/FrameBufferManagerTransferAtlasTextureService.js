import { $getActiveTransferBounds, $getActiveAtlasIndex, $getActiveAllTransferBounds } from "../../AtlasManager";
import { $gl, $context } from "../../WebGLUtil";
import { $atlasFrameBuffer, $setFramebufferBound } from "../../FrameBufferManager";
/**
 * @type {number}
 * @private
 */
...
export const execute = () => {
    ...
    if ($currentIndex === $getActiveAtlasIndex()) {
        ...
        if (bounds[2] !== -Number.MAX_VALUE
            ...
            $gl.blitFramebuffer(0, 0, atlasAttachmentObject.width, atlasAttachmentObject.height, 0, 0, atlasAttachmentObject.width, atlasAttachmentObject.height, $gl.COLOR_BUFFER_BIT, $gl.NEAREST);
