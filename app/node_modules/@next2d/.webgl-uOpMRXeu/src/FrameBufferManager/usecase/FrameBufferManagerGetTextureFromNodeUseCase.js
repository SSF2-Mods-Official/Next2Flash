...
import { $getDrawBitmapFrameBuffer, $getReadBitmapFrameBuffer, $readFrameBuffer } from "../../FrameBufferManager";
import { $gl } from "../../WebGLUtil";
import { $getActiveAtlasIndex, $setActiveAtlasIndex, $getAtlasTextureObject } from "../../AtlasManager";
/**
...
export const execute = (node) => {
    ...
    $gl.framebufferTexture2D($gl.FRAMEBUFFER, $gl.COLOR_ATTACHMENT0, $gl.TEXTURE_2D, atlasTextureObject.resource, 0);
    ...
    $gl.framebufferTexture2D($gl.FRAMEBUFFER, $gl.COLOR_ATTACHMENT0, $gl.TEXTURE_2D, textureObject.resource, 0);
    ...
    // execute
    $gl.blitFramebuffer(node.x, node.y, node.x + node.w, node.y + node.h, 0, 0, node.w, node.h, $gl.COLOR_BUFFER_BIT, $gl.NEAREST);
    // restore
