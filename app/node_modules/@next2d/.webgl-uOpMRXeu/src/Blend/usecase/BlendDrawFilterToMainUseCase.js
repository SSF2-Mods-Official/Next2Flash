 ...
 * @protected
 */
export const execute = (texture_object, color_transform, x, y) => {
        ...
        case "copy":
            {
                ...
                shaderManagerSetMatrixTextureWithColorTransformUniformService(shaderManager, color_transform, width, height);
                // テクスチャをバインド
        ...
        default:
            {
                ...
                shaderManagerSetBlendWithColorTransformUniformService(shaderManager, color_transform[0], color_transform[1], color_transform[2], color_transform[3], color_transform[4], color_transform[5], color_transform[6], color_transform[7]);
                shaderManagerDrawTextureUseCase(shaderManager);
                // メインのAttachmentObjectに描画して終了
                $context.bind($context.$mainAttachmentObject);
                $context.reset();
