 ...
 * @static
 */
export const BLEND_TEMPLATE = (operation, with_color_transform) => {
    let blendFunction;
    switch (operation) {
        case "subtract":
