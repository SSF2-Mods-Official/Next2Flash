...
import { $getGradientAttachmentObject, $getGradientLUTGeneratorMaxLength } from "../../GradientLUTGenerator";
/**
 ...
 * @protected
 */
export const execute = (ratios, colors, alphas) => {
    ...
    for (let begin = 0; begin < stopsLength; begin += maxLength - 1) {
        ...
        const shaderManager = variantsGradientLUTShaderService(end - begin, false);
        gradientLUTSetFilterUniformService(shaderManager, ratios, colors, alphas, begin, end);
        gradientLUTGeneratorFillTextureUseCase(shaderManager, ratios[begin] / 255, ratios[end - 1] / 255);
    }
    blendResetService();
