 ...
 * @public
 */
export const execute = (shader_manager, type, matrix, inverse_matrix, focal_point_ratio = 0, points = null, grid_data = null) => {
    ...
    if (type === 0) {
        ...
        highp[index++] = points[0];
        highp[index++] = points[1];
        highp[index++] = points[2];
        highp[index] = points[3];
    }
    else {
