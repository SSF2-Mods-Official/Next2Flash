 ...
 * @protected
 */
export const execute = (x, y, preserve_alpha, clamp) => {
    ...
    const shaderManager = new ShaderManager(TEXTURE_TEMPLATE(), CONVOLUTION_FILTER_TEMPLATE(mediumpLength, x, y, preserve_alpha, clamp));
