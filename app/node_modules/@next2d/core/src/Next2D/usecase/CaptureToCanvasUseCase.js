...
export const execute = async (display_object, opstions = null) => {
    ...
    // draw
    await playerTransferCanvasPostMessageService(display_object, tMatrix, tColorTransform, transferredCanvas, opstions && opstions.bgColor ? parseInt(opstions.bgColor.replace("#", ""), 16) : 0x000000, opstions && opstions.bgAlpha ? opstions.bgAlpha : 0);
    // restore
    if (isResize) {
