 ...
 * @protected
 */
export const execute = (gradient_bevel_filter) => {
    const colors = gradient_bevel_filter.colors ? gradient_bevel_filter.colors : [];
    const alphas = gradient_bevel_filter.alphas ? gradient_bevel_filter.alphas : [];
    const ratios = gradient_bevel_filter.ratios ? gradient_bevel_filter.ratios : [];
