...
export class DropShadowFilter extends BitmapFilter {
     ...
     * @public
     */
    constructor(distance = 4, angle = 45, color = 0, alpha = 1, blur_x = 4, blur_y = 4, strength = 1, quality = 1, inner = false, knockout = false, hide_object = false) {
        super();
        /**
         ...
         * @private
         */
        Object.defineProperty(this, "_$inner", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
         ...
         * @private
         */
        Object.defineProperty(this, "_$hideObject", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
     ...
     */
    clone() {
        return new DropShadowFilter(this._$distance, this._$angle, this._$color, this._$alpha, this._$blurX, this._$blurY, this._$strength, this._$quality, this._$inner, this._$knockout, this._$hideObject);
    }
    /**
