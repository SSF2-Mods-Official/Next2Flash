...
export const execute = (display_object, matrix, renderer_width, renderer_height) => {
    ...
    switch (true) {
        case display_object.isContainerEnabled:
            bounds = displayObjectContainerCalcBoundsMatrixUseCase(display_object, matrix);
            break;
        case display_object.isShape:
            bounds = shapeCalcBoundsMatrixUseCase(display_object, matrix);
            break;
        case display_object.isText:
            bounds = textFieldCalcBoundsMatrixUseCase(display_object, matrix);
            break;
        case display_object.isVideo:
            bounds = videoCalcBoundsMatrixUseCase(display_object, matrix);
            break;
        default:
            break;
    }
