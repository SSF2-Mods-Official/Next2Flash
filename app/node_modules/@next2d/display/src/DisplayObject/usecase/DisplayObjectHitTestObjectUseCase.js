 ...
 * @protected
 */
export const execute = (display_object, target_display_object) => {
    const rawBounds1 = displayObjectGetRawBoundsUseCase(display_object);
    const matrix1 = display_object.concatenatedMatrix;
    const bounds1 = displayObjectCalcBoundsMatrixService(rawBounds1[0], rawBounds1[1], rawBounds1[2], rawBounds1[3], matrix1.rawData);
    // pool
    ...
    const bounds2 = displayObjectCalcBoundsMatrixService(rawBounds2[0], rawBounds2[1], rawBounds2[2], rawBounds2[3], matrix2.rawData);
    // pool
