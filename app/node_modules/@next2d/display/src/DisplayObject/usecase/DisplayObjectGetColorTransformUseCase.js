...
export const execute = (display_object) => {
    ...
    return colorTransform
        ? new ColorTransform(colorTransform[0], colorTransform[1], colorTransform[2], colorTransform[3], colorTransform[4], colorTransform[5], colorTransform[6], colorTransform[7])
        : new ColorTransform();
};
