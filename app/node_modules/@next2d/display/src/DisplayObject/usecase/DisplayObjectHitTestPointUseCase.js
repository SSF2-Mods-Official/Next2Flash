 ...
 * @protected
 */
export const execute = (display_object, x, y, shape_flag = false) => {
    if (shape_flag) {
        ...
        switch (true) {
            case display_object.isContainerEnabled:
                return displayObjectContainerMouseHitUseCase(display_object, $colorContext, matrix, $hitObject);
            case display_object.isShape:
                return shapeHitTestUseCase(display_object, $colorContext, matrix, $hitObject);
            case display_object.isText:
                return textFieldHitTestUseCase(display_object, $colorContext, matrix, $hitObject);
            case display_object.isVideo:
                return videoHitTestUseCase(display_object, $colorContext, matrix, $hitObject);
            default:
                return false;
        }
    }
    ...
    const bounds = displayObjectCalcBoundsMatrixService(rawBounds[0], rawBounds[1], rawBounds[2], rawBounds[3], martix ? martix : $MATRIX_ARRAY_IDENTITY);
    // pool
