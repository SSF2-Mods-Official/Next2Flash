    ...
    for (let idx = 0; idx < recodes.length;) {
        ...
        switch (type) {
            ...
            case Graphics.FILL_STYLE:
                array.push(recodes[idx++], recodes[idx++], recodes[idx++], recodes[idx++]);
                break;
            case Graphics.CUBIC:
                array.push(recodes[idx++], recodes[idx++], recodes[idx++], recodes[idx++], recodes[idx++], recodes[idx++]);
                break;
            ...
            case Graphics.GRADIENT_FILL:
                {
                    ...
                    for (let idx = 0; idx < sortStops.length; ++idx) {
            ...
            case Graphics.BITMAP_FILL:
                {
                    ...
                    array.push(bitmapData.width, bitmapData.height, buffer.length);
