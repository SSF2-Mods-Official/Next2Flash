import { $getArray, $MATRIX_ARRAY_IDENTITY, $convertColorStringToNumber } from "./DisplayObjectUtil";
/**
...
export class GraphicsGradientFill {
    ...
    constructor(type, colors, alphas, ratios, matrix = null, spread_method = "pad", interpolation_method = "rgb", focal_point_ratio = 0) {
        ...
        Object.defineProperty(this, "_$spreadMethod", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_$interpolationMethod", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_$focalPointRatio", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_$colorStops", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
