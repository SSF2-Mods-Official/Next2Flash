...
import type { ColorTransform, Matrix, Rectangle, Point } from "@next2d/geom";
...
export declare class DisplayObject extends EventDispatcher {
     ...
     * @public
     */
    readonly isContainerEnabled: boolean;
    /**
     ...
     * @public
     */
    readonly isTimelineEnabled: boolean;
    /**
     ...
     * @return {Rectangle}
     */
    getBounds<D extends DisplayObject>(target_display_object?: D | null): Rectangle;
    /**
