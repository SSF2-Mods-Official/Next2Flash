 ...
 * @public
 */
export const execute = (display_object_container, display_object, index = -1) => {
    ...
    if ($stageAssignedMap.has(display_object_container.instanceId)) {
        ...
        if (display_object.isContainerEnabled) {
            displayObjectContainerAssignStageAndRootService(display_object);
        }
    }
    ...
    if ($stageAssignedMap.has(display_object_container.instanceId)) {
        ...
        if (display_object.isContainerEnabled) {
            displayObjectContainerAddedToStageService(display_object);
        }
    }
