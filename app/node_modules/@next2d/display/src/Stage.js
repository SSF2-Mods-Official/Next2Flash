...
import { $pointer, $rootMap, $stageAssignedMap } from "./DisplayObjectUtil";
/**
...
export class Stage extends DisplayObjectContainer {
    ...
    constructor() {
         ...
         * @private
         */
        Object.defineProperty(this, "_$ready", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
     ...
     * @protected
     */
    $mouseHit(hit_context, matrix, hit_object) {
        displayObjectContainerMouseHitUseCase(this, hit_context, matrix, hit_object, true);
    }
}
/**
 * @type {Stage}
