...
//fox_fla.fox_landmasterstart_finalform2_142
        ...
        public function landmasterControlsCPU():*
        {
            ...
            if (this.self.isCPU())
            {
                ...
                if (this.cpuTarget != null)
                {
                    ...
                    {
                        this.cpuFireTimer = 0;
                        if ((((_local_1 * _local_2) < (_local_3 * _local_3)) && (!(this.cpuTarget.getType() === "SSF2Beacon"))))
                        {
                            if (SSF2API.random() > (1 - (this.self.getCPULevel() / 10)))
                            {
