define("ace/mode/actionscript_highlight_rules", ["require", "exports", "module", "ace/lib/oop",
  ...
  function i() {
    this.$rules = {
      start: [{
        ...
        token: ["meta.preprocessor.actionscript.2", "punctuation.definition.preprocessor.actionscript.2",
          "meta.preprocessor.actionscript.2"
        ],
        regex: "^([ \\t]*)(#)([a-zA-Z]+)"
      }, {
        token: ["storage.type.function.actionscript.2", "meta.function.actionscript.2",
          "entity.name.function.actionscript.2", "meta.function.actionscript.2",
        ...
        token: ["storage.type.class.actionscript.2", "meta.class.actionscript.2",
          "entity.name.type.class.actionscript.2", "meta.class.actionscript.2",
          "storage.modifier.extends.actionscript.2", "meta.class.actionscript.2",
  ...
  }, n.inherits(i, e), t.ActionScriptHighlightRules = i
}), define("ace/mode/folding/cstyle", ["require", "exports", "module", "ace/lib/oop", "ace/range",
  ...
  var i = e("../../lib/oop"),
    ...
    t = t.FoldMode = function (e) {
      e && (this.foldingStartMarker = new RegExp(this.foldingStartMarker.source.replace(/\|[^|]*?$/, "|" + e
        .start)), this.foldingStopMarker = new RegExp(this.foldingStopMarker.source.replace(/\|[^|]*?$/, "|" + e
          .end)))
    };
  i.inherits(t, e),
    function () {
      this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/, this.foldingStopMarker =
        /^[^\[\{\(]*([\}\]\)])|^[\s\*]*(\*\/)/, this.singleLineBlockCommentRe = /^\s*(\/\*).*\*\/\s*$/, this
        .tripleStarBlockCommentRe = /^\s*(\/\*\*\*).*\*\/\s*$/, this.startRegionRe = /^\s*(\/\*|\/\/)#?region\b/,
        this._getFoldWidgetBase = this.getFoldWidget, this.getFoldWidget = function (e, t, o) {
          var i = e.getLine(o);
          if (this.singleLineBlockCommentRe.test(i) && !this.startRegionRe.test(i) && !this.tripleStarBlockCommentRe
            .test(i)) return "";
          e = this._getFoldWidgetBase(e, t, o);
          ...
          var a = n.match(this.foldingStartMarker);
          if (a) {
            var r = a.index;
            if (a[1]) return this.openingBracketBlock(e, a[1], o, r);
            var l = e.getCommentFoldRange(o, r + a[0].length, 1);
            return l && !l.isMultiLine() && (i ? l = this.getSectionRange(e, o) : "all" != t && (l = null)), l
          }
          if ("markbegin" !== t) return (a = n.match(this.foldingStopMarker)) ? (r = a.index + a[0].length, a[1] ?
            this.closingBracketBlock(e, a[1], o, r) : e.getCommentFoldRange(o, r, -1)) : void 0
        }, this.getSectionRange = function (e, t) {
          for (var o = (l = e.getLine(t)).search(/\S/), i = t, n = l.length, a = t += 1, r = e.getLength(); ++t <
            r;) {
            var l, s = (l = e.getLine(t)).search(/\S/);
            if (-1 !== s) {
              if (s < o) break;
          ...
          return new c(i, n, a, e.getLine(a).length)
        }, this.getCommentRegionBlock = function (e, t, o) {
          for (var i = t.search(/\s*$/), n = e.getLength(), a = o, r = /^\s*(?:\/\*|\/\/|--)#?(end)?region\b/, l =
            1; ++o < n;) {
            t = e.getLine(o);
            var s = r.exec(t);
            if (s && (s[1] ? l-- : l++, !l)) break
          }
          if (a < o) return new c(a, i, o, t.length)
        }
    }.call(t.prototype)
}), define("ace/mode/actionscript", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text",
  "ace/mode/actionscript_highlight_rules", "ace/mode/folding/cstyle"
], function (e, t, o) {
  "use strict";

  function i() {
    this.HighlightRules = r, this.foldingRules = new l, this.$behaviour = this.$defaultBehaviour
  }
  var n = e("../lib/oop"),
    a = e("./text").Mode,
    r = e("./actionscript_highlight_rules").ActionScriptHighlightRules,
...
}), window.require(["ace/mode/actionscript"], function (e) {
