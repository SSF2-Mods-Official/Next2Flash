package blackmage_fla
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol1433")]
   public dynamic class NSpecial_42 extends MovieClip
   {
      ...
      public function reflected(param1:* = null) : *
      {
         this.self.playSound("reflect_sfx");
         SSF2API.attachEffect("reflect_effect",{
            "x":param1.data.opponent.getX(),
            "y":param1.data.opponent.getY()
         });
      }
      ...
      {
         var _loc1_:* = this.self.getGlobalVariable("BMageNSpecSFX");
         if(_loc1_ != null)
         {
            SSF2API.stopSound(_loc1_);
            this.self.setGlobalVariable("BMageNSpecSFX",null);
         }
      }
      
      public function stunProjectile(param1:*) : void
      {
         this.curCharge = param1.data.caller.getGlobalVariable("BMageNSpecCharge");
         if(this.curCharge < 1)
         {
            this.curCharge = 1;
         }
         this.self.playAttackSound(4);
         param1.data.opponent.forceHitStun(15 * this.curCharge);
      }
