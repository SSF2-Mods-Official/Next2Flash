package blackmage_fla
{
   ...
   public dynamic class ThiefProjectile_183 extends MovieClip
   {
      ...
      public function onHit(param1:* = null) : *
      {
         if(Boolean(param1.data.receiver.isDisposed()) || param1.data.receiver.getType() !== "SSF2Character")
         {
            return;
         }
         param1.data.receiver.grab(this.character.getUID(),true,false,true);
         this.temp = this.character.getGlobalVariable("fsTargets");
         this.temp.push(param1.data.receiver);
