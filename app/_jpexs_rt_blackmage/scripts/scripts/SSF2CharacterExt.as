package
{
   ...
   public class SSF2CharacterExt extends SSF2Character
   {
      ...
      public function removeAllEffects(param1:* = null) : *
      {
         ...
         if(Boolean(this.clearListener) && this.hasEventListener(SSF2Event.STATE_CHANGE,this.removeAllEffects) || param1 != null)
         {
      ...
      private function _moveOpp(param1:* = null) : *
      {
         ...
         else
         {
            ...
            if(this._receiverType == "Character" && Boolean(this._notArmoured(this._receiver)) || this._receiverType == "Item" || this._receiverType == "Enemy" || this._receiverType == "Projectile")
            {
