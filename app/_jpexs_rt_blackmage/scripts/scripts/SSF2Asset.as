package
{
   ...
   public dynamic class SSF2Asset extends MovieClip
   {
      ...
      {
         this._register[param1] = param2;
      }
      
      public function getProp(param1:String) : *
      {
         return this._register[param1] || null;
      }
      ...
      public function initAPI(param1:*) : Class
      {
         ...
         if(!(myDomainName == "localhost" || myDomainName == "127.0.0.1" || myDomainName.match(/^app#com\.mcleodgaming\.ssf2(?:2|3|4)?$/) || myDomainName.match(/mcleodgaming\.com$/) || Boolean(myDomainName.match(/supersmashflash\.com$/)) || myDomainName.match(/ssf2\.com$/)) && Boolean(loaderInfo.loader))
         {
            menu = SSF2API.createCustomMenu(SSF2CustomMenu);
            menu.show();
            mc = menu.getMC();
