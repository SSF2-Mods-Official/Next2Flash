...
class Russia extends Language
{
    ...
    {
        return new Map([
            ["{{前のキーフレームと座標を合わせる}}", "Выравнивание координат по предыдущему ключевому кадру"],
            ["{{前のキーフレームと変形を合わせる}}", "Выровнять деформацию по предыдущему ключевому кадру"],
            ["{{次のキーフレームに移動}}", "Переход к следующему ключевому кадру"],
            ["{{前のキーフレームに移動}}", "Перейти к предыдущему ключевому кадру"],
            ["{{全てのスクリプトをコピー}}", "Копирование всех скриптов"],
            ["{{スクリプトをコピー}}", "Скопировать скрипт"],
            ["{{スクリプトをペースト}}", "Вставить сценарий"],
            ["{{全てのラベルをコピー}}", "Скопировать все ярлыки"],
            ["{{ラベルをコピー}}", "Копировать ярлыки"],
            ["{{ラベルをペースト}}", "Вставить ярлыки"],
            ["{{全てのサウンドをコピー}}", "Скопировать все звуки"],
            ["{{サウンドをコピー}}", "Скопировать звук"],
            ["{{サウンドをペースト}}", "Вставить звук"],
            ["{{書き出し先の選択}}", "Место экспорта"],
            ["{{画質}}", "Качество"],
            ["{{座標}}", "Координаты"],
            ["{{MovieClipを編集}}", "Редактирование видеоклипа"],
            ["{{親の階層へ移動}}", "Перемещение в родительскую иерархию"],
            ["{{ロックされたレイヤーです}}", "Заблокированный слой"],
            ["{{トゥイーンには複数のオブジェクトを設置できません}}", "Несколько объектов не могут быть помещены в твин"],
            ["{{名前が重複しています}}", "Дублирующее имя"],
            ["{{名前は必須です}}", "Имя обязательно"],
            ["{{基準点}}", "точка отсчёта"],
