...
class Japanese extends Language
{
    ...
    {
        return new Map([
            ["{{前のキーフレームと座標を合わせる}}", "前のキーフレームと座標を合わせる"],
            ["{{前のキーフレームと変形を合わせる}}", "前のキーフレームと変形を合わせる"],
            ["{{次のキーフレームに移動}}", "次のキーフレームに移動"],
            ["{{前のキーフレームに移動}}", "前のキーフレームに移動"],
            ["{{全てのスクリプトをコピー}}", "全てのスクリプトをコピー"],
            ["{{スクリプトをコピー}}", "スクリプトをコピー"],
            ["{{スクリプトをペースト}}", "スクリプトをペースト"],
            ["{{全てのラベルをコピー}}", "全てのラベルをコピー"],
            ["{{ラベルをコピー}}", "ラベルをコピー"],
            ["{{ラベルをペースト}}", "ラベルをペースト"],
            ["{{全てのサウンドをコピー}}", "全てのサウンドをコピー"],
            ["{{サウンドをコピー}}", "サウンドをコピー"],
            ["{{サウンドをペースト}}", "サウンドをペースト"],
            ["{{書き出し先の選択}}", "書き出し先の選択"],
            ["{{画質}}", "画質"],
            ...
            ["{{トゥイーンには複数のオブジェクトを設置できません}}", "トゥイーンには複数のオブジェクトを設置できません"],
            ["{{名前が重複しています}}", "名前が重複しています"],
            ["{{名前は必須です}}", "名前は必須です"],
            ["{{基準点}}", "基準点"],
            ["{{自由変形ツール}}", "自由変形ツール"],
            ["{{キーフレームに変換}}", "キーフレームに変換"],
