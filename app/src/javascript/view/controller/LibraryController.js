...
<div draggable="true" class="library-list-box-child" id="library-child-id-${id}" data-library-id="${id}">
    <div class="library-list-box-name">
        ...
        <p>
            ...
            <input type="text" id="library-name-input-${id}" data-library-id="${id}" data-type="name" value="${name}" style="display: none;" autocomplete="off" tabindex="-1">
        </p>
    </div>
    <div class="library-list-box-symbol">
        <p>
            ...
            <input type="text" id="library-symbol-name-input-${id}" data-library-id="${id}" data-type="symbol" value="${symbol}" style="display: none;" autocomplete="off" tabindex="-1">
        </p>
    </div>
</div>`;
