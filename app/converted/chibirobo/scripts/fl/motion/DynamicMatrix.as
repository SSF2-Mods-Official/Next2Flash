package fl.motion
{
    public class DynamicMatrix
    {
        ...
        protected function Create(_arg_1:int, _arg_2:int):void
        {
            ...
            for (_local_3 = 0; _local_3 < _arg_2; _local_3++)
            {
                    this.m_matrix[_local_3] = new Array(_arg_1);
            for (_local_4 = 0; _local_4 < _arg_2; _local_4++)
            {
        ...
        public function LoadIdentity():void
        {
            ...
            if (this.m_matrix)
            {
            for (_local_1 = 0; _local_1 < this.m_height; _local_1++)
            {
            for (_local_2 = 0; _local_2 < this.m_width; _local_2++)
            {
        ...
        public function Multiply(_arg_1:DynamicMatrix, _arg_2:int=0):Boolean
        {
            ...
            for (_local_6 = 0; _local_6 < this.m_height; _local_6++)
            {
            for (_local_7 = 0; _local_7 < _local_4; _local_7++)
            {
                        _local_8 = 0;
                        _local_9 = 0;
            for (_local_10 = 0; (_local_9 < Math.max(this.m_height, _local_3)) && (_local_10 < Math.max(this.m_width, _local_4)); _local_10++)
            {
                            _local_8 += (_arg_1.GetValue(_local_9, _local_7) * this.m_matrix[_local_6][_local_10]);
                            _local_9++;
                        };
            ...
            for (_local_6 = 0; _local_6 < _local_3; _local_6++)
            {
            for (_local_7 = 0; _local_7 < this.m_width; _local_7++)
            {
            ...
            for (_local_7 = 0; _local_7 < this.m_width; _local_7++)
            {
                        _local_8 = 0;
                        _local_9 = 0;
            for (_local_10 = 0; (_local_9 < Math.max(_local_3, this.m_height)) && (_local_10 < Math.max(_local_4, this.m_width)); _local_10++)
            {
                            _local_8 += (this.m_matrix[_local_9][_local_7] * _arg_1.GetValue(_local_6, _local_10));
                            _local_9++;
                        };
                        _local_5.SetValue(_local_6, _local_7, _local_8);
                    };
        ...
        public function MultiplyNumber(_arg_1:Number):Boolean
        {
            ...
            for (var _local_2:int = 0; _local_2 < this.m_height; _local_2++)
            {
            for (_local_3 = 0; _local_3 < this.m_width; _local_3++)
            {
                    _local_4 = 0;
        ...
        public function Add(_arg_1:DynamicMatrix):Boolean
        {
            ...
            for (var _local_4:int = 0; _local_4 < this.m_height; _local_4++)
            {
            for (_local_5 = 0; _local_5 < this.m_width; _local_5++)
            {
                    _local_6 = 0;
