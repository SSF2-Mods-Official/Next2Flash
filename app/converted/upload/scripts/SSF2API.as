package
{
    ...
    public class SSF2API
    {
        ...
        public static const VERSION_MINOR:int = 55;
        ...
        public static function calculateSelfHitStun(_arg_1:Number, _arg_2:Number):Number
        {
            if (!isReady())
            {
                return 0;
            };
            return m_api.calculateSelfHitStun(_arg_1, _arg_2);
        }
