package
{
    ...
    public class BombermanExt extends SSF2Character
    {

        private var effects:Array;
        private var clearListener:Boolean;
        public var bombArray:Array;
        public const MAX_BOMBS:int = 5;

        public function BombermanExt(_arg_1:*):void
        {
        ...
        {
            this.bombArray = [];
            SSF2API.print("Bomberman initialized.");
        }
