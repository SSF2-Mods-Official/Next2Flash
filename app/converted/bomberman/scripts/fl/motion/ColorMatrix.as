package fl.motion
{
    public class ColorMatrix extends DynamicMatrix
    {
        ...
        public function SetHueMatrix(_arg_1:Number):void
        {
            ...
            for (var _local_10:int = 0; _local_10 < 3; _local_10++)
            {
            for (_local_11 = 0; _local_11 < 3; _local_11++)
            {
        ...
        public function GetFlatArray():Array
        {
            ...
            var _local_2:int;
            for (var _local_3:int = 0; _local_3 < 4; _local_3++)
            {
            for (_local_4 = 0; _local_4 < 5; _local_4++)
            {
