package
{
    ...
    public class SSF2Utils
    {
        ...
        {
            for (var _local_3:Number = (_arg_2 - _arg_1); _local_3 < -180; _local_3 += 360)
            {
            };
            while (_local_3 > 180)
            {
        ...
        {
            var _local_2:int;
            for (_local_2 = 0; _local_2 < _arg_1.totalFrames; _local_2++)
            {
        ...
        public static function cast(_arg_1:*, _arg_2:Class=null):*
        {
            ...
            {
                var _local_4:* = _arg_1.getType();
                while ("SSF2Character" === _local_4)
                {
        ...
        private static function getCostumeObject(_arg_1:Object=null):Object
        {
            ...
            while (hasnext2(_local_4, _local_5))
            {
                var _local_3:* = nextname(_local_4, _local_5);
        ...
        public static function replacePalette(_arg_1:MovieClip, _arg_2:Object, _arg_3:int=1, _arg_4:Boolean=false, _arg_5:Boolean=false):void
        {
            ...
            if ((_arg_2 || _arg_4) && _arg_1)
            {
                _local_7 = 0;
                _local_6 = null;
            for (_local_7 = 0; _local_7 < _arg_1.numChildren; _local_7++)
            {
                    ...
                    else if ((_arg_1.getChildAt(_local_7) is MovieClip) && (_arg_3 > 0))
                    {
        ...
        private static function replacePaletteHelper(_arg_1:BitmapData, _arg_2:Object):void
        {
            ...
            for (_local_3 = 0; _local_3 < _arg_2.colors.length; _local_3++)
            {
                if (_arg_2.colors[_local_3] != _arg_2.replacements[_local_3])
                {
                    _arg_1.threshold(_arg_1, paletteRect, palettePoint, "==", _arg_2.colors[_local_3], _arg_2.replacements[_local_3], 4294967295, true);
                };
            };
        }
        ...
        public static function decel(_arg_1:Number, _arg_2:Number):Number
        {
            ...
            {
                _local_3 = (_arg_1 > 0);
                _arg_1 -= ((_arg_1 > 0) ? Math.abs(_arg_2) : -(Math.abs(_arg_2)));
