package captainfalcon_fla
{
    ...
    public dynamic class Grab_156 extends MovieClip
    {
        ...
        public function Grab_156()
        {
            super();
            addFrameScript(0, this.frame1, 2, this.frame3, 3, this.frame4, 15, this.frame16, 16, this.frame17, 20, this.frame21, 21, this.frame22, 23, this.frame24, 36, this.frame37, 37, this.frame38, 38, this.frame39, 39, this.frame40, 40, this.frame41, 43, this.frame44, 44, this.frame45, 50, this.frame51);
        }
        ...
        {
            this.self.playSound("brawl_punch_m");
            this.self.attachEffect("global_dust_light", {"x":this.self.flipX(-3)});
        }
