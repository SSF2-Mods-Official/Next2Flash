package gameandwatch_fla
{
    ...
    public dynamic class Grab_87 extends MovieClip
    {
        ...
        public function Grab_87()
        {
            super();
            addFrameScript(0, this.frame1, 2, this.frame3, 3, this.frame4, 15, this.frame16, 16, this.frame17, 20, this.frame21, 21, this.frame22, 24, this.frame25, 36, this.frame37, 37, this.frame38, 38, this.frame39, 39, this.frame40, 40, this.frame41, 42, this.frame43, 43, this.frame44, 52, this.frame53);
        }
        ...
        {
            this.self.attachEffect("global_dust_light", {"x":this.self.flipX(-13)});
        }
