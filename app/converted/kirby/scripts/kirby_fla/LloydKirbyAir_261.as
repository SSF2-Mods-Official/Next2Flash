package kirby_fla
{
    ...
    public dynamic class LloydKirbyAir_261 extends MovieClip
    {
        ...
        public function LloydKirbyAir_261()
        {
            super();
            addFrameScript(0, this.frame1, 7, this.frame8, 8, this.frame9, 18, this.frame19, 26, this.frame27, 28, this.frame29, 29, this.frame30, 38, this.frame39, 42, this.frame43);
        }
        ...
        public function toGround(_arg_1:*=null):*
        {
            ...
            this.self.setGlobalVariable("KirbyLloydFrame", currentFrame);
            this.self.setGlobalVariable("KirbyLloydDubs", this.doubleFang);
            this.self.forceAttack("kirby_lloyd", null, true);
        }
        ...
        internal function frame1():*
        {
            ...
            if (SSF2API.isReady() && this.self)
            {
                this.controls = null;
                this.noPress = false;
                this.doubleFang = this.self.getGlobalVariable("KirbyLloydDubs");
                this.curFrame = this.self.getGlobalVariable("KirbyLloydFrame");
                this.self.addEventListener(SSF2Event.GROUND_TOUCH, this.toGround);
                this.self.setGlobalVariable("KirbyLloydDubs", false);
                this.self.setGlobalVariable("KirbyLloydFrame", 0);
