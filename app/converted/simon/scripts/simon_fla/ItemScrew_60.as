package simon_fla
{
    ...
    public dynamic class ItemScrew_60 extends MovieClip
    {
        ...
        public function test(_arg_1:*=null):*
        {
            SSF2API.print("crap");
            this.self.toLand();
        }
        ...
        internal function frame1():*
        {
            ...
            {
                this.self.addEventListener(SSF2Event.GROUND_TOUCH, this.test);
            };
        }
