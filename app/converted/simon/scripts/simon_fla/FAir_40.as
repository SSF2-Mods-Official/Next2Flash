package simon_fla
{
    ...
    public dynamic class FAir_40 extends MovieClip
    {
        ...
        public var forwardStats:Object;
        public var forwardUpStats:Object;
        public var forwardDownStats:Object;
        public var playsound:Number;
        public var audio:Number;

        public function FAir_40()
        {
            super();
        ...
        internal function frame1():*
        {
            ...
            this.kbConstantMultUp = 1.15;
            this.forwardStats = {"direction":45};
            this.forwardUpStats = {"direction":70};
            this.forwardDownStats = {"direction":40};
        ...
        internal function frame6():*
        {
            ...
            {
                this.self.stancePlayFrame("Fair");
            };
        }

        internal function frame7():*
        {
            this.self.updateAttackBoxStats(1, this.forwardUpStats);
            this.self.updateAttackBoxStats(2, this.forwardUpStats);
            this.self.updateAttackBoxStats(3, this.forwardUpStats);
        ...
        {
            this.self.updateAttackBoxStats(1, this.forwardStats);
            this.self.updateAttackBoxStats(2, this.forwardStats);
            this.self.updateAttackBoxStats(3, this.forwardStats);
            this.self.setLandingLag(true);
        }
        ...
        {
            this.self.updateAttackBoxStats(1, this.forwardDownStats);
            this.self.updateAttackBoxStats(2, this.forwardDownStats);
            this.self.updateAttackBoxStats(3, this.forwardDownStats);
            this.self.setLandingLag(true);
        }
