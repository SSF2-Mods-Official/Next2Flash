package lucario_fla
{
    ...
    public dynamic class UpTilt_37 extends MovieClip
    {
        ...
        {
            super();
            addFrameScript(0, this.frame1, 2, this.frame3, 3, this.frame4, 4, this.frame5, 5, this.frame6, 6, this.frame7, 8, this.frame9, 13, this.frame14);
        }
        ...
        internal function frame3():*
        {
            ...
            this.self.addEffectToList(this.self.attachEffect("trail_lucario_utilt", {
                "scaleX":1.15,
                "scaleY":1.15,
                "parentLock":true,
                "syncHitStun":true
