package
{
   ...
   public dynamic class black_mage extends MovieClip
   {
      ...
      public function black_mage()
      {
         ...
         ,63,this.frame64,64,this.frame65,65,this.frame66,66,this.frame67,67,this.frame68,68,this.frame69,69,this.frame70,70,this.frame71,71,this.frame72,72,this.frame73,73,this.frame74,74,this.frame75,75,this.frame76,76,this.frame77,77,this.frame78,78,this.frame79,79,this.frame80,80,this.frame81,81,this.frame82,82,this.frame83,83,this.frame84,84,this.frame85,85,this.frame86,86,this.frame87,87,this.frame88,88,this.frame89);
      }
      ...
      {
         this.xframe = "item_pickup";
         stop();
      }
      
      internal function frame40() : *
      {
         this.xframe = "item_jab";
         stop();
      }
      
      internal function frame41() : *
      {
         this.xframe = "item_dash";
         stop();
      }
      
      internal function frame42() : *
      {
         this.xframe = "item_tilt";
         stop();
      }
      
      internal function frame43() : *
      {
         this.xframe = "item_smash";
         stop();
      }
      
      internal function frame44() : *
      {
         this.xframe = "item_homerun";
         stop();
      }
      
      internal function frame45() : *
      {
         this.xframe = "item_fan";
         stop();
      }
      
      internal function frame46() : *
      {
         this.xframe = "item_shoot";
         stop();
      }
      
      internal function frame47() : *
      {
         this.xframe = "item_heavyshoot";
         stop();
      }
      
      internal function frame48() : *
      {
         this.xframe = "item_raise";
         stop();
      }
      
      internal function frame49() : *
      {
         this.xframe = "item_screw";
         stop();
      }
      
      internal function frame50() : *
      {
         this.xframe = "item_float";
         stop();
      }
      
      internal function frame51() : *
      {
         this.xframe = "item_firedash";
         stop();
      }
      
      internal function frame52() : *
      {
         this.xframe = "item_bubblebounce";
         stop();
      }
