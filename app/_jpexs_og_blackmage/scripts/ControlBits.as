package
{
   public class ControlBits
   {
      ...
      {
         bits = param1 ? bits | 0x10 : bits & ~0x10;
      }
      ...
      {
         bits = param1 ? bits | 0x20 : bits & ~0x20;
      }
      ...
      {
         bits = param1 ? bits | 0x40 : bits & ~0x40;
      }
      ...
      {
         bits = param1 ? bits | 0x80 : bits & ~0x80;
      }
      ...
      {
         bits = param1 ? bits | 0x0100 : bits & ~0x0100;
      }
      ...
      {
         bits = param1 ? bits | 0x0200 : bits & ~0x0200;
      }
      ...
      {
         bits = param1 ? bits | 0x0400 : bits & ~0x0400;
      }
      ...
      {
         bits = param1 ? bits | 0x0800 : bits & ~0x0800;
      }
      ...
      {
         bits = param1 ? bits | 0x1000 : bits & ~0x1000;
      }
      ...
      {
         bits = param1 ? bits | 0x2000 : bits & ~0x2000;
      }
      ...
      {
         bits = param1 ? bits | 0x4000 : bits & ~0x4000;
      }
      ...
      {
         bits = param1 ? bits | 0x8000 : bits & ~0x8000;
      }
      ...
      {
         bits = param1 ? bits | 0x010000 : bits & ~0x010000;
      }
      ...
      {
         bits = param1 ? bits | 0x020000 : bits & ~0x020000;
      }
      ...
      {
         bits = param1 ? bits | 0x040000 : bits & ~0x040000;
      }
      ...
      {
         bits = param1 ? bits | 0x080000 : bits & ~0x080000;
      }
      ...
      {
         bits = param1 ? bits | 0x100000 : bits & ~0x100000;
      }
      ...
      {
         bits = param1 ? bits | 0x200000 : bits & ~0x200000;
      }
